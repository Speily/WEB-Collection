...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-lg"><b>CHN</b>-CRM</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">${sessionScope.currentUser.userName}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                ...
                                <small>
                                    <c:forEach items="${sessionScope.currentUser.deptList}" var="dept">
                                        ${dept.deptName} &nbsp;
                                    </c:forEach>
                                </small>
                            </p>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <!-- 客户管理 -->
            <li class="treeview ${fn:startsWith(param.active, "cust_") ? 'active' : ''}">
                <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="${param.active == 'cust_my' ? 'active' : ''}"><a href="/customer/my"><i class="fa fa-circle-o"></i> 我的客户</a></li>
                    <li class="${param.active == 'cust_public' ? 'active' : ''}"><a href="/customer/public"><i class="fa fa-circle-o"></i> 公海客户</a></li>
                </ul>
            </li>
            <!-- 工作记录 -->
            <li class="treeview">

        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a href="/chance/my" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</a>
                ...
                <div class="box-footer">
                    <%--<span style="color: #ccc" class="pull-right">
                        创建日期：<fmt:formatDate value="${chance.createTime}" pattern="yyyy-MM-dd HH:mm"/>
                    </span>--%>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/chance/my/new/record" id="recordForm" method="post">
            ...
            <div class="modal fade" id="changeProgressModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="/chance/my/${chance.id}/state" id="updateProgressForm">
                                <input type="hidden" name="custId" value="${customer.id}">
    ...
    $(function () {
        ...
        $("#delBtn").click(function () {
           layer.confirm("确定要删除该机会吗?",function () {
               window.location.href = "/chance/my/"+chanceId+"/del";
           });
        });
